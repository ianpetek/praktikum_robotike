...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='pr_robot_description').find('pr_robot_description')
    ...
    # sdf_path = os.path.join(pkg_share, 'models/urdf/pr_robot/model.sdf')
    ...
    spawn_entity = launch_ros.actions.Node(
        ...
        arguments=['-entity', 'pr_robot', '-topic', 'robot_description'],
        parameters=[{'use_sim_time': use_sim_time}],
        output='screen'
    )
